...
public class UI {
    ...
    public void setCredits(){
        ...
        credits[1] = "";
        credits[2] = "Created by: George Bishop";
        credits[3] = "";
        credits[4] = "";
        credits[5] = "With Special Thanks to the Spring Crew of '22 ";
        credits[6] = "";
        credits[7] = "";
        credits[8] = "Annie Ewell";
        credits[9] = "Adriene Lock";
        credits[10] = "Brad Pulley";
        credits[11] = "Caleb Saarm";
        credits[12] = "Carina Barbosa-Nunez";
        credits[13] = "Carlos Alvarado";
        credits[14] = "Carson Jenkins";
        credits[15] = "Cate Etchason";
        credits[16] = "Collin MacPherson";
        credits[17] = "Connor Schuett";
        credits[18] = "Emelia Merrick";
        credits[19] = "Grant Hutchison";
        credits[20] = "Hadassah Messer";
        credits[21] = "Izzy Sloan";
        credits[22] = "Jana Buzov";
        credits[23] = "Miro Buzov";
        credits[24] = "Julia Poole";
        credits[25] = "Reina";
        credits[26] = "Karae Shuler";
        credits[27] = "Lena Zabaneh";
        credits[28] = "Lexi Pierce";
        credits[29] = "Mark 'Pops' Craven";
        credits[30] = "Megan Gill";
        credits[31] = "Olivia Campbell";
        credits[32] = "Sarah Gainey";
        credits[33] = "Sasha Emmerich";
        credits[34] = "Stephen Whitehurst";
        credits[35] = "Turner Keith";
        credits[36] = "Walter Cheeks";
        credits[37] = "Elise";
        credits[38] = "";
        credits[39] = "Music: ";
        credits[40] = "Dog - C418";
